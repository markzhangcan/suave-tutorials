...
), "These tutorials only work with the SUAVE 2.5.2 release"
...
def vehicle_setup():
    ...
    landing_gear.main_tire_diameter = 1.000 * Units.m
    ...
    thrust.total_design = 2 * 24000.0 * Units.N  # Newtons
...
def mission_setup(analyses):
    ...
    segment.distance = 2490.0 * Units.nautical_miles
